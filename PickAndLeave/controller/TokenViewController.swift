...
protocol PassingTokenDelegate{
    func addTokenWithPerson(enteredId: String)
}
class TokenViewController: UIViewController{
    var delegate: PassingTokenDelegate?
    let itemText: UITextField = {
        let sampleTextField =  UITextField()
        sampleTextField.placeholder = "Enter Token Number"
    ...
    @objc func submitButtonPressed(){
        delegate?.addTokenWithPerson(enteredId: itemText.text!)
